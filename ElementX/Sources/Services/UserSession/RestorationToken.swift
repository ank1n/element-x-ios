...
extension MatrixRustSDK.Session: @retroactive Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        /// SDK 26.06.03 renamed the Session field oidcData → oauthData, but the PERSISTED key must
        /// stay "oidcData" or every existing login on device would fail to restore after the update.
