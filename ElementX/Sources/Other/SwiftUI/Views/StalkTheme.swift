...
enum SL10n {
    ...
    // MARK: - Ailock (STMOB-274)

    static let ailockTitle = NSLocalizedString("stalk_ailock_title", tableName: "Localizable", value: "Айлок", comment: "Ailock app title")
    static let ailockDescription = NSLocalizedString("stalk_ailock_description", tableName: "Localizable", value: "Чат с ИИ-агентом", comment: "Ailock app description")
    static let ailockComposerPlaceholder = NSLocalizedString("stalk_ailock_composer_placeholder", tableName: "Localizable", value: "Спросите Айлок", comment: "Ailock composer placeholder")
    static let ailockEmptyTitle = NSLocalizedString("stalk_ailock_empty_title", tableName: "Localizable", value: "Чем помочь?", comment: "Ailock empty state title")
    static let ailockEmptySubtitle = NSLocalizedString("stalk_ailock_empty_subtitle", tableName: "Localizable", value: "Задайте вопрос или приложите файл — агент ответит здесь", comment: "Ailock empty state subtitle")
    static let ailockWorking = NSLocalizedString("stalk_ailock_working", tableName: "Localizable", value: "Работает…", comment: "Ailock agent is working")
    static let ailockQuestionWaiting = NSLocalizedString("stalk_ailock_question_waiting", tableName: "Localizable", value: "Агент ждёт ответа", comment: "Agent asked a question")
    static let ailockHistoryTitle = NSLocalizedString("stalk_ailock_history_title", tableName: "Localizable", value: "История", comment: "Ailock conversations title")
    ...
    static let ailockEarlier = NSLocalizedString("stalk_ailock_earlier", tableName: "Localizable", value: "Ранее", comment: "Earlier section")
    static let ailockDelete = NSLocalizedString("stalk_ailock_delete", tableName: "Localizable", value: "Удалить", comment: "Delete conversation")
    static let ailockRetry = NSLocalizedString("stalk_ailock_retry", tableName: "Localizable", value: "Повторить", comment: "Retry button")
    static let ailockUnavailable = NSLocalizedString("stalk_ailock_unavailable", tableName: "Localizable", value: "Айлок недоступен на этом сервере", comment: "Ailock not deployed")
    ...
    static let ailockAttachFromDisk = NSLocalizedString("stalk_ailock_attach_from_disk", tableName: "Localizable", value: "Из Диска", comment: "Attach from Disk")
    static let ailockDiskPickerTitle = NSLocalizedString("stalk_ailock_disk_picker_title", tableName: "Localizable", value: "Выбор файла", comment: "Disk picker title")
    static let ailockDiskSearch = NSLocalizedString("stalk_ailock_disk_search", tableName: "Localizable", value: "Поиск по файлам", comment: "Disk picker search")
    static let ailockDiskEmpty = NSLocalizedString("stalk_ailock_disk_empty", tableName: "Localizable", value: "Файлов нет", comment: "Disk picker empty")
    static let ailockDiskLoadFailed = NSLocalizedString("stalk_ailock_disk_load_failed", tableName: "Localizable", value: "Не удалось загрузить файлы", comment: "Disk list failed")
    static let ailockDiskFileFailed = NSLocalizedString("stalk_ailock_disk_file_failed", tableName: "Localizable", value: "Не удалось получить файл", comment: "Disk file failed")
    static let ailockDiskFileUnsupported = NSLocalizedString("stalk_ailock_disk_file_unsupported", tableName: "Localizable", value: "Этот файл нельзя приложить", comment: "Disk file unsupported")
    static let ailockCancel = NSLocalizedString("stalk_ailock_cancel", tableName: "Localizable", value: "Отмена", comment: "Cancel")
    ...
    static let ailockCopy = NSLocalizedString("stalk_ailock_copy", tableName: "Localizable", value: "Скопировать", comment: "Copy assistant reply")
    static let ailockSaveToDisk = NSLocalizedString("stalk_ailock_save_to_disk", tableName: "Localizable", value: "Сохранить на Диск", comment: "Save assistant reply to Disk")
    static let ailockSavedToDisk = NSLocalizedString("stalk_ailock_saved_to_disk", tableName: "Localizable", value: "Сохранено на Диск", comment: "Reply saved to Disk toast")
    static let ailockSaveToDiskFailed = NSLocalizedString("stalk_ailock_save_to_disk_failed", tableName: "Localizable", value: "Не удалось сохранить на Диск", comment: "Save to Disk failed")
    static let ailockReplyDocName = NSLocalizedString("stalk_ailock_reply_doc_name", tableName: "Localizable", value: "Ответ Айлока", comment: "Fallback Disk document name for a saved reply")
